...
contract RaffleTest is Test{
    ...
    function testEmitsEventOnEntrance() public{
        vm.prank(PLAYER);
        vm.expectEmit(true,false,false,false,address(raffle));    //function expectEmit(bool checkTopic1, checkTopic2, checkTopic3, checkData aadress emitter(address of the emitter) ) external {}
    ...
    function testPerformUpkeepUpdatesRaffleStateAndEmitsRequestId() public raffleEnteredAndTimePassed{
        //Act
        vm.recordLogs();
        raffle.performUpkeep(""); //emit requested
    ...
    function testFulfillRandomWordsCanOnlyBeCalledAfterPerformUpkeep(uint256 requestId) public raffleEnteredAndTimePassed skipFork{
        //Arrange
